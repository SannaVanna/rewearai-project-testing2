...
import { Camera, Upload, Sparkles, RefreshCw, Heart, Share2, ChevronLeft, ChevronRight } from "lucide-react";
import tryonImage from "@/assets/tryon-preview.jpg";

const sampleOutfits = [
  { id: 1, name: "Casual Chic", items: ["White blouse", "Beige trousers", "Nude heels"] },
  { id: 2, name: "Office Ready", items: ["Camel coat", "White shirt", "Grey pants"] },
  { id: 3, name: "Weekend Vibes", items: ["Cream sweater", "Jeans", "Sneakers"] },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <h1 className="font-display text-2xl font-semibold text-foreground">Virtual Try-On</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
              ...
              {!photoUploaded ? (
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                  ...
                  <p className="text-muted-foreground text-center mb-6 max-w-xs">
                    Take a full-body photo or selfie to see outfits on yourself
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button variant="elegant" onClick={handleUpload}>
          ...
          <div className="space-y-6">
            ...
            {!generated && (
              <div className="bg-card rounded-3xl p-6 shadow-soft animate-fade-up">
                ...
                <div className="space-y-4">
                  {[
                    { step: 1, title: "Upload your photo", desc: "A full-body shot works best" },
                    { step: 2, title: "Choose an outfit", desc: "Mix items from your wardrobe" },
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Photos are auto-deleted after processing</span>
            </div>
          </div>
        </div>
      </div>
